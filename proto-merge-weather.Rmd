...
Think of this as a "one-dimensional" data fusion problem. The two data sets are very similar except for the reported `measurement_units`. Sources that ostensibly measure the same phenomena may also differ in their `measurement_type`, sampling intervals (e.g. `measurement_freq`), or in the equipment used (`sensor_type`). All of these variations may introduce bias, consistency, veracity, and/or accuracy problems if they're merged without consideration. 
